...
if release:
  ...
  # '0.0.1.dev20180305'
  project_name = 'tfc-nightly' + maybe_gpu_suffix
...
setup(
    name=project_name,
    version=VERSION,
    description='Model compression for TensorFlow',
    author='Kevin Kiningham',
    author_email='kkiningh@stanford.edu',
    url='http://github.com/kkiningh/tf_compress',
    license='Apache 2.0',
    ...
    keywords='tensorflow model compression machine learning',
)
